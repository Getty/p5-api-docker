...
# ABSTRACT: Removed in 0.004 -- replaced by API::Docker::Type::Config
our $VERSION = '0.005';
use strict;
use warnings;
use Carp qw( croak );
...
my $REFUSED =
  ...
  . ' decoded_data are unchanged on them, composed in from'
  . ' API::Docker::Role::Entity::Config. This stub refuses';

# The croak below is what a caller normally hits. AUTOLOAD is for the one who
# swallowed it -- eval { require API::Docker::Config } and then called a
